...
public class Ventana1 extends javax.swing.JFrame {
	...
	private void componentes1() {
		...
		pregunta.setText(
				"A través de la respiración,la energía química de los alimentos es transformada y almacenada\r\n"
						+ " en la célula en una molécula llamada ATP (adenosin trifosfato).");
		...
		imagen1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/MITOCO.jpg")));
