...
public class Ventana6 extends javax.swing.JFrame {
	...
	private void componentes6() {
		JLabel pregunta = new JLabel();
		pregunta.setFont(new java.awt.Font("Arial", 0, 20));
		pregunta.setText("¿Qué estructura se parece más a la celula vegetal?");
		...
		imagen1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/CVEGE.jpg")));
		imagen1.setBounds(25, 50, 600, 300);

		JLabel imagen2 = new JLabel();
		imagen2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/CANI.jpg")));
